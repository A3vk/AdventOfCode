...
// Subcommands
// Run --year <year> --day <day> (defaults to today) --all (flag) --sample (flag)
// Download --year <year> --day <day> (defaults to today) --part <part> (enum, defaults to 1)
...
// var downloadCommand = new Command("download", "Downloads a ");
...
// else
// {
//     results.Add(runner.Run(2023, 10, true));
// }
//
// // DateTime today = DateTime.Now;
